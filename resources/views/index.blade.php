    ...
    ================================================= -->
        ...
        <div class="sign-up-form">
					...
					<div class="form-wrapper">
						...
						<form action="{{route('check.index')}}" method = "post">
							@csrf
							<fieldset class="form-group">
								<input type="text" class="form-control" id="example-name" name = "name" placeholder="Enter name">
							</fieldset>
							<fieldset class="form-group">
								<input type="email" class="form-control" id="example-email" name = "email" placeholder="Enter email">
							</fieldset>
							<fieldset class="form-group">
								<input type="password" class="form-control" id="example-password" name = "password" placeholder="Enter a password">
							</fieldset>
					...
					<a href="/check#login">Already have an account?</a>
