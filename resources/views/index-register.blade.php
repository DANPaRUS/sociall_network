            ...
            <div class="reg-form-container"> 
              ...
              <div class="reg-options">
                <ul class="nav nav-tabs" id = "tabs">
                  <li class = "in active"><a href="#register"  data-toggle="tab">Register</a></li>
                  ...
                  <form name="registration_form" id='registration_form' class="form-inline">
                    <div class="row">
                      <div class="form-group col-xs-6">
                        ...
                        <input id="firstname" class="form-control input-group-lg" type="text" name="name" title="Enter first name" value = "{{(!empty($data)) ? $data['name']: ''}}" placeholder="First name"/>
                      </div>
                      <div class="form-group col-xs-6">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input id="email" class="form-control input-group-lg" type="text" name="email" title="Enter Email" value = "{{(!empty($data)) ? $data['email']: ''}}" placeholder="Your Email"/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-xs-12">
                        <label for="password" class="sr-only">Password</label>
                        <input id="password" class="form-control input-group-lg" type="password" name="password" title="Enter password" value = "{{(!empty($data)) ? $data['password']: ''}}" placeholder="Password"/>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="form-group col-sm-3 col-xs-6">
                        ...
                        <select class="form-control" name = 'date' id="day">
